...
//                 mostrarHistorico();  // Carregar o histórico após salvar
//             } else {
//                 showMessage("Erro ao salvar o endereço: " + data.error);
//             }
//         })
//         .catch(error => {
...
//         limparCampos();
//     } else {
//         showMessage("Por favor, preencha todos os campos obrigatórios (endereço, data da coleta, horário e tipo de coleta).");
//     }
// }
...
//     const tipos = document.querySelectorAll('.tipo-coleta');
//     tipos.forEach(tipo => {
...
//             const ultimoEndereco = data.enderecos[data.enderecos.length - 1];

//             // Criar um item de lista (li) para o último endereço
//             let itemLista = document.createElement("li");
            
//             // Preencher o conteúdo do item com os dados do último endereço
//             itemLista.innerHTML = `
//                 <strong>Estado:</strong> ${ultimoEndereco.estado} <br> 
//                 <strong>Rua:</strong> ${ultimoEndereco.rua} <br> 
//                 <strong>Número:</strong> ${ultimoEndereco.numero} <br>
//                 <strong>CEP:</strong> ${ultimoEndereco.cep} <br>
//                 <strong>Bairro:</strong> ${ultimoEndereco.bairro} <br>
//                 <strong>Cidade:</strong> ${ultimoEndereco.cidade} <br>
//                 <strong>Data da Coleta:</strong> ${ultimoEndereco.data_coleta} <br>
//                 <strong>Hora da Coleta:</strong> ${ultimoEndereco.horario_coleta} <br>
//                 <strong>Tipo de Coleta:</strong> ${ultimoEndereco.tipo_coleta} <br>
//                 <strong>Observações:</strong> ${ultimoEndereco.observacao_coleta ? ultimoEndereco.observacao_coleta : 'Nenhuma'}
//             `;

//             // Adicionar o item à lista
//             listaEnderecos.appendChild(itemLista);
//         } else {
//             // Caso não haja endereços no histórico
//             let mensagem = document.createElement("li");
//             mensagem.innerText = "Nenhum endereço salvo.";
//             listaEnderecos.appendChild(mensagem);
//         }
//     })
//     .catch(error => {
//         console.error('Erro ao carregar histórico:', error);
//         showMessage("Erro ao carregar histórico.");
//     });
// }
